...
def test_source_priority():
    ...
    print("  ✓ indeed: 1 (high)")
    print("  ✓ wellfound: 1 (high)")
    print("  ✓ linkedin: 2 (medium)")
    print("  ✓ glassdoor: 2 (medium)")
    print()
...
def test_resolve_duplicate():
    ...
    print("  ✓ Higher priority source -> update_full")
    ...
    print("  ✓ Same priority, longer description -> update_description")
    ...
    print("  ✓ Same priority, shorter description -> skip")
    ...
    print("  ✓ Lower priority source -> skip")
    print()
...
def test_import_process():
    ...
    print("  ✓ Correct number of unique jobs")
    ...
    print("  ✓ OpenAI job updated to Indeed version")
    ...
    print("  ✓ Stripe job kept LinkedIn version (longer description)")
